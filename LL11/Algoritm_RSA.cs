...
class Algoritm_RSA
    {
        ...
        { 
            ...
            {
              Cripto[i] = BigInteger.ModPow(new BigInteger(Byte), e, n);
                i++;
            }
        ...
        public static string DecriptoRSA(BigInteger[] RSACripto, BigInteger d, BigInteger n)
        {
            string text = "";
